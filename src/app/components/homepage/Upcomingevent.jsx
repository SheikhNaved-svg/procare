    ...
    <section className="w-full  flex flex-col lg:flex-row py-20">
       <Image
        ...
        <div className='lg:w-[50%] w-full  relative'>
            <div className='w-full absolute lg:left-[-70px] bg-white pb-10 px-5 lg:pr-0 mt-5 lg:mt-0 lg:pl-20 flex flex-col gap-5'>
            ...
            <div className='bg-[#F1ECE0] py-10 mt-[200px] lg:mt-[165px] px-10'>
